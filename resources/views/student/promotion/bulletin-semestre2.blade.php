        ...
        @if (strpos($semestreObjet->name, '2') !== false ||
            ...
            <table style="margin-left:35px">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: center; font-weight:bold" colspan="6">MOYENNE ECU FONDAMENTAUX (80%)
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center; font-weight:bold" colspan="8">SEMINAIRE ET TRAVAUX PRATIQUES
                        </td>
                    </tr>
