                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Notes <span class="text-danger">({{$userLevel->mclass->name}})</span> </h3>
                        </div>
                        <div class="card-header">
                                        ...
                                        <tbody>
                                            @if ($courses->isNotEmpty())
                                                @foreach ($courses as $course)
                                                    @if ($course->matiere && $course->matiere->ue->semestres->contains('name', 'Semestre 1 (MA)'))
                                                        <tr>
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="5">
                                                        <p class="text-center text-uppercase text-danger">Données inexistantes</p>
                                                    </td>
                                                </tr>
                                            @endif
                                        </tbody>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @if ($courses->isNotEmpty())
                                                @foreach ($courses as $course)
                                                    @if ($course->matiere && $course->matiere->ue->semestres->contains('name', 'Semestre 2 (MA)'))
                                                        <tr>
                                                            <td>{{ $course->matiere->name }}</td>
                                                            <td>{{ $course->matiere->ue->name }}</td>
