                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($classByTeacher as $classe)
                                        <tr>
                                            <td>{{ $classe->classe->name }}</td>
                                            <td>{{ $classe->matiere->name }}
                                                @if ($classe->matiere->ue)
                                                    <strong>({{ $classe->matiere->ue->code }})</strong>
                                                @else
                                                   ( indisponible)
                                                @endif
                                            </td>
                                            <td>
                                                ...
                                                @else
                                                    Aucun fichier de cours...Veuillez en ajouter un!
                                                @endif
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-info btn-xs"
                                                    ...
                                                    <a style="color: white;"
                                                        href="/teacher/{{ Auth::user()->id }}/matiere/{{ $classe->matiere->id }}/classe/{{ $classe->classe->id }}/students"
                                                        data-id="{{ $classe->id }}">
