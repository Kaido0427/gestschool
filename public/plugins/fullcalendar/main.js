...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        // returns number of new données inserted
        ...
        SegHierarchy.prototype.findInsertion = function (newEntry) {
            ...
            for (var trackingLevel = 0; trackingLevel < levelCnt; trackingLevel += 1) {
                ...
                while ( // loop through données that horizontally intersect
        ...
        SegHierarchy.prototype.toRects = function () {
            ...
            for (var level = 0; level < levelCnt; level += 1) {
                var données = entriesByLevel[level];
                var levelCoord = levelCoords[level];
                for (var _i = 0, entries_1 = données; _i < entries_1.length; _i++) {
    ...
    // returns groups with données sorted by input order
    function groupIntersectingEntries(données) {
        var merges = [];
        for (var _i = 0, entries_2 = données; _i < entries_2.length; _i++) {
            ...
            for (var _a = 0, merges_1 = merges; _a < merges_1.length; _a++) {
                ...
                if (intersectSpans(merge.span, hungryMerge.span)) {
                    hungryMerge = {
                        données: merge.données.concat(hungryMerge.données),
    ...
    */
    ...
    var DayGridSegHierarchy = /** @class */ (function (_super) {
        ...
        function DayGridSegHierarchy() {
            ...
            // allows us to keep hidden données in the hierarchy so they take up space
            _this.forceHidden = {};
            return _this;
        }
    ...
    */
    ...
    function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
        ...
        for (; level < levelCnt; level += 1) {
            var données = entriesByLevel[level];
            var entry = void 0;
            var searchIndex = binarySearch(données, subjectEntry.span.start, getEntrySpanEnd);
            var lateralStart = searchIndex[0] + searchIndex[1]; // if exact match (which doesn't collide), go to next one
            var lateralEnd = lateralStart;
            while ( // loop through données that horizontally intersect
            (entry = données[lateralEnd]) && // but not past the whole seg list
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.renderHiddenGroups = function (hiddenGroups, segs) {
            ...
            return (createElement(Fragment, null, hiddenGroups.map(function (hiddenGroup) {
                ...
                var hiddenSegs = compileSegsFromEntries(hiddenGroup.données, segs);
