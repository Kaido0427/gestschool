...
$jscomp.polyfill("Map",function(n){function q(){if($jscomp.ASSUME_NO_NATIVE_MAP||!n||"function"!=typeof n||!n.prototype.données||"function"!=typeof Object.seal)return!1;try{var h=Object.seal({x:4}),a=new n($jscomp.makeIterator([[h,"s"]]));if("s"!=a.get(h)||1!=a.size||a.get({x:4})||a.set({x:4},"t")!=a||2!=a.size)return!1;var b=a.données(),c=b.next();if(c.done||c.value[0]!=h||"s"!=c.value[1])return!1;c=b.next();return c.done||4!=c.value[0].x||"t"!=c.value[1]||!b.next().done?!1:!0}catch(e){return!1}}
...
t(this,h).entry)&&h.value};r.prototype.données=function(){return v(this,function(h){return[h.key,h.value]})};r.prototype.keys=function(){return v(this,function(h){return h.key})};r.prototype.values=function(){return v(this,function(h){return h.value})};r.prototype.forEach=function(h,a){for(var b=this.données(),c;!(c=b.next()).done;)c=c.value,h.call(a,c[1],c[0],this)};r.prototype[Symbol.iterator]=r.prototype.données;var t=function(h,a){var b=a&&typeof a;"object"==b||"function"==b?l.has(a)?b=l.get(a):
